...
**The main objective of this project is to develop a backend system that can:**

- Automatically review source code
- Identify possible defects and vulnerabilities
- Provide explanations for detected problems
- Suggest possible improvements
- Help developers write cleaner and more reliable software
- Reduce manual code review effort


The system should allow users to provide source code for analysis.
